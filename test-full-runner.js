...
function normalizePdfText(text) {
  ...
  // 2. Question Header normalization
  ...
  // 3. Choice markers normalization
...
res.forEach(q => {
  console.log(`Q: ${q.id} | Correct: ${q.correctAnswer} | Choices: ${q.choices.length} | Text: ${q.text.slice(0, 50)}...`);
});
