...
function parseMarkdownToQuestions(markdownText) {
  ...
  const saveCurrentQuestion = () => {
    console.log("CALL saveCurrentQuestion, currentQText len:", currentQText.length, "choices:", currentChoices.length, "hasCurrentHeader:", hasCurrentHeader); let qTextClean = currentQText.trim();
