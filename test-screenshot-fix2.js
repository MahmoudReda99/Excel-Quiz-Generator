...
function normalizeExtractedPdfText(text) {
  ...
  // E.g. "( أ :ةحيحصلا الإجابة" or ":ةحيحصلا الإجابة" -> "\nالإجابة الصحيحة: "
  ...
  // 3. Normalize reversed / mangled question headers
  // E.g. ": 1 لؤئسملا" or "1 لؤسملا :" or "السؤال 1 :" or "1: السؤال"
  clean = clean.replace(/(?:[\s:\(\)]|^)(?:السؤال|سؤال|س|Q|Question|لؤسملا|لؤئسملا|لؤمسملا|لؤشملأا)\s*:?\s*(\d+)\s*:?/gi, '\n\n#### السؤال $1 :\n');
  clean = clean.replace(/[:\s]*(\d+)\s*:?\s*(?:السؤال|سؤال|س|Q|Question|لؤسملا|لؤئسملا|لؤمسملا|لؤشملأا)(?:[\s:\(\)]|$)/gi, '\n\n#### السؤال $1 :\n');
