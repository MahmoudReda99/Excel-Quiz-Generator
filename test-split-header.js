...
function normalizePdfText(text) {
  ...
  // 3. Question Header normalization
...
const cleaned = normalizePdfText(snippet);
const lines = cleaned.split(/\r?\n/).map(l => l.trim()).filter(Boolean);

let qHeadersFound = lines.filter(l => l.startsWith('#### السؤال'));
console.log("Question headers found in text lines:", qHeadersFound);
