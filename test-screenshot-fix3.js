...
function normalizeExtractedPdfText(text) {
  ...
  // 3. Normalize reversed / mangled question headers (Only السؤال / لؤسملا / Q)
  clean = clean.replace(/(?:[\s:\(\)]|^)(?:السؤال|سؤال|س|Q|Question|لؤسملا|لؤئسملا|لؤمسملا)\s*:?\s*(\d+)\s*:?/gi, '\n\n#### السؤال $1 :\n');
  clean = clean.replace(/[:\s]*(\d+)\s*:?\s*(?:السؤال|سؤال|س|Q|Question|لؤسملا|لؤئسملا|لؤمسملا)(?:[\s:\(\)]|$)/gi, '\n\n#### السؤال $1 :\n');
